...
PVE 是基于 Debain 来改造的, 所以其实大多数配置都跟 Debain 配置方法一样
...
![alpinect](/assets/alpinect.png){data-zoomable}
...
![totpl](/assets/totpl.png){data-zoomable}

使用模版创建 CT 容器

![toct](/assets/toct.png){data-zoomable}

我的模版配置如下 `/etc/pve/lxc/100.conf`
