...
| iKuai | CT   | `LAN`             | 192.168.6.1/24 | **192.168.6.2** | 192.168.6.2 | 小鸡:主路由   |
| iKuai | CT   | `WAN`             | PPPOE          | PPPOE           | 225.6.6.6   | 小鸡:主路由   |
...
| ------ | ---- | ----------------- | -------------- | --------------- | ---------- | ----------- | ----------------- |
| cloud  | CT   | `LAN`             | 192.168.6.3/24 | **192.168.6.1** | DHCP/SLAAC | 192.168.6.1 | smb/sftpgo/alist  |
| tv     | CT   | `LAN`             | 192.168.6.4/24 | **192.168.6.2** | DHCP/SLAAC | 192.168.6.1 | 电视鸡            |
| docker | CT   | `LAN`             | 192.168.6.5/24 | **192.168.6.1** | DHCP/SLAAC | 192.168.6.2 | CT 套娃 docker 鸡 |
| bt     | CT   | `LAN`             | 192.168.6.8/24 | **192.168.6.1** | DHCP/SLAAC | 192.168.6.1 | 下载鸡 xunlei/bt  |
